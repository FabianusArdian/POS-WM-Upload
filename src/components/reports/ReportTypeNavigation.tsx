...
interface ReportTypeNavigationProps {
  currentPath: string;
...
export default function ReportTypeNavigation({ currentPath, onNavigate }: ReportTypeNavigationProps) {
  return (
      ...
      {reportTypes.map((report) => (
        <Card
          ...
          className={`cursor-pointer hover:bg-muted/50 transition-colors ${
            report.path === currentPath ? "bg-primary/10" : ""
          }`}
